...
def artifacts():
    if sel == 1: #주소, 0x[0-9A-Fa-f]{40,44}, ^0x[a-fA-F0-9]{40}, # G:\내 드라이브\mem_dump\memdump_A_210512_test.mem
        p = re.compile(rb'0x[0-9A-Fa-f]{40}', re.IGNORECASE | re.DOTALL )
    elif sel == 2: #개인키
        p = re.compile(rb'^[0-9a-f]{64}', re.IGNORECASE | re.DOTALL | re.MULTILINE) 
    elif sel == 3: #키스토어
...
# test address : 0x9ae08d0118e105dce648a7fba6fc12b2c3e9c288
# G:\내 드라이브\mem_dump\memdump_A_210512_test.mem
# G:\내 드라이브\mem_dump\20221217.mem
